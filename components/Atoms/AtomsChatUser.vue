<template>
  <span class="relative">
    ...
    <span :style="`color: ${user.color}`" class="font-semibold">
      {{ user.displayName }}:
    </span>
  </span>
</template>
